...
class StatementItemDto:
    ...
    def __init__(self, id_: str, time: int, description: str, mmc: int, original_mmc: int, hold: bool, amount: int,
        ...
        self.mmc = mmc
        self.original_mmc = original_mmc
        self.hold = hold
        self.amount = amount
